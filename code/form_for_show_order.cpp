...
Form_For_Show_Order::Form_For_Show_Order(QWidget *parent) :
    QWidget(parent),
...
void Form_For_Show_Order::on_back_button_clicked()
{
    clear_form();
    this->close();
    emit to_main_window();
...
void Form_For_Show_Order::clear_form()
{
    _order.clear();
...
Form_For_Show_Order::~Form_For_Show_Order()
{
    delete ui;
}

void Form_For_Show_Order::on_number_order_valueChanged(int number)
{
    if(number!=0)
    {
...
void Form_For_Show_Order::on_enter_button_clicked()
{
    clear_form();
...
void Form_For_Show_Order::on_complete_button_clicked()
{
